...
/*
    ...
    // Access an already loaded myTexture
    std::shared_ptr<myTexture> existingmyTexture = Get<myTexture>("assets/myTextures/hero.png");
    if (existingmyTexture) {
        std::cout << "myTexture is already loaded: " << existingmyTexture->filepath << std::endl;
    } else {
